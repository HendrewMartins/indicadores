package br.hendrew.api.rest.util;
...
import br.hendrew.api.rest.bindings.CapabilityType;
import br.hendrew.api.rest.bindings.FileUploadType;
import br.hendrew.api.rest.bindings.GranteeCapabilitiesType;
import br.hendrew.api.rest.bindings.GroupType;
import br.hendrew.api.rest.bindings.ObjectFactory;
import br.hendrew.api.rest.bindings.PermissionsType;
...
import br.hendrew.api.rest.bindings.SiteType;
import br.hendrew.api.rest.bindings.TableauCredentialsType;
import br.hendrew.api.rest.bindings.TsRequest;
import br.hendrew.api.rest.bindings.TsResponse;
...
public class RestApiUtils {
    ...
    private static UriBuilder getApiUriBuilder() {
        return UriBuilder.fromPath(m_properties.getProperty("server.host") + "/api/3.6");
    }
    /**
    ...
    public static void initialize() {
        try {
            m_properties.load(new FileInputStream("C:/indicadores/src/main/java/br/hendrew/res/config.properties"));
